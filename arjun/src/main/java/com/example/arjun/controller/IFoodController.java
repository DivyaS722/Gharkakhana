...
private IFoodService IFoodService;
	 ...
	 @PostMapping("/FoodId")
		...
		@PostMapping("/Addmenu")
		public ResponseEntity<Food> login(@RequestBody Food food, HttpSession session) {
		...
		@GetMapping("/food/{id}")
		private Food getBooks(@PathVariable("id") String id) {
			return IFoodService.getFoodById(id);
		}

		@DeleteMapping("/Food/{foodid}")
		private void deleteBook(@PathVariable("foodid") String id) {
